  ...
  return (
    <div id="Contact">
      <Container>
        ...
        >
          <div className="my-0 flex items-center gap-4 w-full lg:gap-8 lg:w-3/4">
          ...
          <div className="flex items-center gap-16 w-full mx-5 lg:w-3/4">
            <div className="GroupCards flex flex-col items-center gap-8 lg:gap-12 w-full lg:w-1/2">
              ...
              <Image src={image1} alt="imageContext" className="not-md:hidden rounded-3xl h-[500px] w-1/2" />
          </div>
        </AnimateDivs>
      </Container>
    </div>
