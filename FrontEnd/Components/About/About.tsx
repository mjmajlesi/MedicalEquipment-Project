      ...
      <Container>
        ...
        >
          <ScrollDivAnime
            ...
            widthRight={1}
          />
          <div className="flex items-center flex-col gap-6 xl:gap-16 w-full">
            <div className="flex flex-col md:flex-row items-start w-full p-2 gap-12 leading-[30px] ">
              <AnimateDivs
                duration={1}
                delay={0.15}
                y={10}
                className=" flex flex-col items-start gap-6 bg-theme-div-text px-8 py-5 rounded-2xl "
              >
                <ScrollDivAnime
                  text="سابقه شرکت"
                  ...
                  widthRight={0}
                />
                <p className="md:text-[19px] text-[14px] sm:text-[16px] text-gray text-justify not-md:px-4">
              ...
              <div className="flex flex-col items-start gap-6 bg-theme-div-text px-8 py-5 rounded-2xl ">
                <ScrollDivAnime
                  text="تاریخچه شرکت"
                  className="text-[24px] lg:text-[28px] xl:text-[30px] font-semibold"
                  widthLeft={1}
                  widthRight={0}
                />
                <p className="w-full not-md:px-4 text-[18px] lg:text-[20px] text-justify text-gray">
              ...
              <AnimateDivs
                ...
                >
                  ...
                  <span className="font-semibold text-[16px] md:text-[18px] transition-all line-clamp-1 duration-300 ease-in-out md:hover:text-[20px] text-gray">
